function saveTightFigure(h,outfilename,adjust)
...
% Usage: saveTightFigure('FG_EPUNews.pdf') or saveTightFigure('FG_EPUNews.jpg')
...
width = (tighest_box(3)-tighest_box(1))+adjust;
height =  (tighest_box(4)-tighest_box(2))+adjust; 
...
set(hfig,'PaperPosition',[adjust/2 adjust/2 width height]);
set(hfig,'Renderer', 'Painters');

%% save
saveas(hfig,outfilename);
% print(hfig,'-dpdf',outfilename) ; %只能用于pdf格式的输出
